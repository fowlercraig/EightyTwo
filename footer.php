...
<footer id="footer">
  <div class="fs-row">
    <div class='fs-cell fs-lg-6 fs-md-6 fs-sm-3'>
      ...
      <a href="<?php echo get_permalink(88); ?>" class="btn btn--nav btn__icon ss-social-circle ss-facebook"></a>
      <a href="<?php echo get_permalink(88); ?>" class="btn btn--nav btn__icon ss-social-circle ss-instagram"></a>
      <a href="<?php echo get_permalink(88); ?>" class="btn btn--nav btn__icon ss-social-circle ss-twitter"></a>
    </div>
