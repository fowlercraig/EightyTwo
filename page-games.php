...
<?php foreach ( $games as $post ) : setup_postdata( $post ); ?>
		...
		<div class="games__item fs-cell fs-xl-3 fs-lg-4 fs-md-half fs-sm-3" data-cat="<?php foreach((get_the_category()) as $category) { echo $category->cat_name; } ?>" data-title="<?php echo get_the_title(); ?>" data-date="<?php the_field('year'); ?>">
